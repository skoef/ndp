...
func TestEncDecDomainName(t *testing.T) {
	tests := []struct {
		...
		{"foo.bar.", []byte{3, 102, 111, 111, 3, 98, 97, 114, 0, 0, 0, 0, 0, 0, 0, 0}},
		{"golang.org.", []byte{6, 103, 111, 108, 97, 110, 103, 3, 111, 114, 103, 0, 0, 0, 0, 0}},
		{"basement.golang.org.", []byte{8, 98, 97, 115, 101, 109, 101, 110, 116, 6, 103, 111, 108, 97, 110, 103, 3, 111, 114, 103, 0, 0, 0, 0}},
	}

	for _, test := range tests {
		// encoding
		encoded := encDomainName([]string{test.name})
